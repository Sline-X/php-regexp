...
//$ - соответствует концу строки (опять же, позиция за концом строки);
...
// '/^\w:/' - соответствует любой строке, начинающейся с буквы, завершенной доветочием; абсолютный путь в windows так выглядит
// '/\.txt$/i' - соответствует строке, хранящей имя файла с расширением txt
// /^$/s - сопоставимо только с пустой строкой, потому что говорит: "сразу после начала строки идет её конец"
